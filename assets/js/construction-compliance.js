...
function showForm(role) {
  ...
  activityCheckboxes.forEach((checkbox) => {
    checkbox.addEventListener("change", () => {
      dynamicFields.innerHTML = dynamicFields.innerHTML.split('<label for="scaffolding">')[0]; // Clear activity fields
